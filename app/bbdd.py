...
p102 = parada(102, "Faliro", 37.94499013986155, 23.66522449702415, (734, 747), (-295.0, -300.0) , "#a0fb0e")   # Draw distinto
...
p114 = parada(114, "Aghios Eleftherios", 38.02011686985624, 23.73178976895845, (893,358),(-139.0, 95.0) , "#a0fb0e")
p115 = parada(115, "Ano Patissia", 38.02378986594461, 23.73596583622907, (917, 335),(-115.0, 117.0) , "#a0fb0e")
...
p206 = parada(206, "Syntagma", 37.97465889945412, 23.735569579603855, (909, 563),(-122.0, -111.0), "#960018") 
...
p205.añadirConexion(p206, 0.660)
p206.añadirConexion(p205, 0.660)

p206.añadirConexion(p207, 1.1)
p207.añadirConexion(p206, 1.1)
...
p206c = parada(206, "Syntagma", 37.97465889945412, 23.735569579603855, (909, 563), (-121.0, -110.0), "#00ffff") 
...
p108a.añadirConexion(p206c, 0.920)
p206c.añadirConexion(p108a, 0.920)

p304.añadirConexion(p206c, 0.92)
p206c.añadirConexion(p304, 0.92)

p206.añadirConexion(p304, 1.1)
p304.añadirConexion(p206, 1.1)
...
# Sintagma
p206.añadirConexion(p206c, 0.2)
p206c.añadirConexion(p206, 0.2)
